...
F 0 "X1" H 5450 1600 50  0000 R CNN
F 1 "ACO-1.8432MHz" H 5550 1150 50  0000 R CNN
F 2 "Oscillator:Oscillator_DIP-14" H 5700 1400 50  0001 C CNN
F 3 "http://www.conwin.com/datasheets/cx/cx030.pdf" H 5150 1750 50  0001 C CNN
	1    5250 1750
	1    0    0    -1  
$EndComp
$Comp
...
F 0 "#PWR0124" H 5250 1300 50  0001 C CNN
...
F 3 "" H 5250 1450 50  0001 C CNN
	...
	1    0    0    -1  
$EndComp
Text GLabel 6850 1200 1    50   Output ~ 0
~CLOCK
Text GLabel 6250 1200 1    50   Output ~ 0
CLOCK
$Comp
L 74xx:74HC04 U?
U 6 1 6006CBEF
...
F 0 "U1" H 6400 1800 50  0000 L CNN
F 1 "74HC04" H 6400 1700 50  0000 L CNN
F 2 "Package_DIP:DIP-14_W7.62mm" H 6550 1750 50  0001 C CNN
F 3 "https://assets.nexperia.com/documents/data-sheet/74HC_HCT04.pdf" H 6550 1750 50  0001 C CNN
	6    6550 1750
	1    0    0    -1  
$EndComp
$Comp
...
Wire Wire Line
	6850 1200 6850 1750
Text GLabel 5550 1350 1    50   Output ~ 0
1.8432MHz
Wire Wire Line
	6250 1200 6250 1750
...
As an option, down-scaling of the\nCPU clock speed is possible here.\n
Wire Notes Line
	5650 1650 6150 1650
Wire Notes Line
	6150 1650 6150 1850
...
The maximum speed is limited by\nthe access time of the control\nFLASH (70ns) or EEPROM (150ns).\n3.6864MHz (2x135ns clock cycle)\nmight be possible with FLASH,\nbut not with EEPROMs.
Text Notes 700  10950 0    50   ~ 0
Ideas:\n- Make the full 128KB of the FLASH available via address jumpers.\n- Make the clock speed adjustable by down-scaling the clock with\n   cascaded counters (20 bits are needed to reach 1Hz).
$EndSCHEMATC
